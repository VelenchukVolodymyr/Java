...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ser.saveToJson(container.getCategories(), jsonFile);
            ser.saveToYaml(container.getCategories(), yamlFile);
        } catch (Exception e) {
        ...
        try {
            List<Category> loadedJson = ser.loadFromJson(jsonFile, Category.class);
            List<Category> loadedYaml = ser.loadFromYaml(yamlFile, Category.class);

            System.out.println("\nLoaded JSON categories: " + loadedJson.size());
            System.out.println("Loaded YAML categories: " + loadedYaml.size());
        } catch (Exception e) {
